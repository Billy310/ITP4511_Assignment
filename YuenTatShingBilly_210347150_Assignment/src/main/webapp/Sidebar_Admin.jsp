...
<aside
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
         ...
         <ul>
            <li class="relative px-6 py-3">
                <% if (PageName.equals(pagenamelist.get(10)) || PageName.equals(pagenamelist.get(11))) {
                        out.print("<span class=\"absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg\" aria-hidden=\"true\"></span>");
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                <% if (PageName.equals(pagenamelist.get(2)) || PageName.equals(pagenamelist.get(7))) {
                        out.print("<span class=\"absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg\" aria-hidden=\"true\"></span>");
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                <% if (PageName.equals(pagenamelist.get(3)) || PageName.equals(pagenamelist.get(8))) {
                        out.print("<span class=\"absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg\" aria-hidden=\"true\"></span>");
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                <% if (PageName.equals(pagenamelist.get(4)) || PageName.equals(pagenamelist.get(9))) {
                        out.print("<span class=\"absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg\" aria-hidden=\"true\"></span>");
