...
<%
    ...
    ArrayList<VenueLocationBean> vlbs = vlb.QueryLocation();

    String UserID = request.getParameter("userid");
    for (int x = 0; x < vlbs.size(); x++) {
        VenueLocationBean vlbb = vlbs.get(x);

        out.print("<form action='EditLocation.jsp' method=\"GET\"    >");
        ...
        out.print("<div>");
        out.print("<p class=\"font-semibold\">" + vlbb.getVenueLocationID() + "</p>");
        out.print("</div>");
        out.print("</div>");
        out.print("</td>");
        out.print("<td class=\"px-4 py-3\">");
        out.print("<div class=\"flex items-center text-sm\">");
        out.print("<div>");
        out.print("<p class=\"font-semibold\">" + vlbb.getVenueLocationName() + "</p>");
        out.print("</div>");
        out.print("</div>");
        out.print("</td>");
        ...
        out.print("<input type=hidden value=" + vlbb.getVenueLocationID() + " name=VenueLocationID />");
